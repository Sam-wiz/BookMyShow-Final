...
router.post("/book-show", async (req, res) => {
  try {
    ...
    // Send email after response to avoid double sending issue
    await emailSender("ticketTemplate.html", populatedBooking.user.email, {
    ...
    }, 'Your Movie Ticket Booking Confirmation');
  } catch (err) {
